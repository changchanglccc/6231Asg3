 ...
 */
@WebServiceClient(name = "SchoolServerImplService", targetNamespace = "http://server/", wsdlLocation = "http://localhost:4020/clinic?wsdl")
public class SchoolServerImplService
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:4020/clinic?wsdl");
