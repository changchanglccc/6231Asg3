...
public interface SchoolServer {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "createNRecord", targetNamespace = "http://server/", className = "clientMTL.CreateSRecord")
    @ResponseWrapper(localName = "createNRecordResponse", targetNamespace = "http://server/", className = "clientMTL.CreateSRecordResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "createDRecord", targetNamespace = "http://server/", className = "clientMTL.CreateTRecord")
    @ResponseWrapper(localName = "createDRecordResponse", targetNamespace = "http://server/", className = "clientMTL.CreateTRecordResponse")
